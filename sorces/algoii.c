...
/*   Updated: 2023/01/12 16:04:49 by dcella-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	lessthanseven(t_list *lst_a, int counter_a)
{
	...
	if (counter_a == 6)
	{
		if (lst_a->pos <= (counter_a/2))
			return (9);
		else if (lst_a->pos > (counter_a/2))
			return (7);
	}
	else
	{
		if (lst_a->pos <= (counter_a/2))
			return (9);
		else if (lst_a->next->pos <= (counter_a/2))
			return(3);
		else
			return (7);
	}
